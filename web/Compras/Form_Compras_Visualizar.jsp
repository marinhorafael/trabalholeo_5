...
<html>
    ...
    <body>
        ...
        <form action="ListaCompras" method="GET">
            ...
            <% }%>
            Cliente:<br>
            <input type="text" name="idCliente" id="idCliente" value="<%=compras.getIdCliente() %>" readonly="true" >
            <br>
            <% if(request.getAttribute("erro") != null){ %> 
                 <h3 style="color:Tomato;"><% out.print(request.getAttribute("erro"));%></h3>        
            <% }%>
            Produto:<br>
            <input type="text" name="idProduto" id="idProduto" value="<%=compras.getIdProduto()%>" readonly="true" >
            <br><br>
